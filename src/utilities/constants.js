...
export const CARDS_CALENDAR = [
	...
	{
		id: 9,
		title: 'Charla sobre Innovación Tecnológica',
		date: ['Fecha: ', '13 noviembre'],
		description: [
			'Actividades: ',
	...
	{
		id: 11,
		title: 'Simposio de Inteligencia Artificial y Machine Learning',
		date: ['Fecha: ', '15 noviembre'],
		description: [
			'Actividades: ',
	...
	{
		id: 12,
		title: 'Exposición de Proyectos de Energías Renovables',
		date: ['Fecha: ', '16 noviembre'],
		description: [
			'Actividades: ',
	...
	{
		id: 13,
		title: 'Workshop sobre Blockchain y Criptomonedas',
		date: ['Fecha: ', '17 noviembre'],
		description: [
			'Actividades: ',
	...
	{
		id: 14,
		title: 'Conmemoración del 20 de Noviembre',
		date: ['Fecha: ', '20 noviembre'],
		description: [
			'Actividades: ',
	...
	{
		id: 15,
		title: 'Conferencia sobre Realidad Virtual y Aumentada',
		date: ['Fecha: ', '21 noviembre'],
		description: [
			'Actividades: ',
	...
	{
		id: 16,
		title: 'Feria de Startups y Emprendimiento',
		date: ['Fecha: ', '22 noviembre'],
		description: [
			'Actividades: ',
	...
	{
		id: 17,
		title: 'Hackathon de Seguridad Cibernética',
		date: ['Fecha: ', '23 noviembre'],
		description: [
			'Actividades: ',
	...
	{
		id: 18,
		title: 'Festival de Innovación y Tecnología',
		date: ['Fecha: ', '24 noviembre'],
		description: [
			'Actividades: ',
