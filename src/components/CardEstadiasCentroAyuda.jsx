              ...
              {selectedText === "Periodo" && (
                ...
                >
                  ...
                  >
                    ...
                    <br />
                    <span style={{ fontWeight: "bold" }}>
                      Cuatriestre Mayo - Agosto:
                    </span>{" "}
                    Estadías de TSU - Estadías de ingeniería
                    <br />
                  </Text>
                </motion.div>
              )}
              ...
              {selectedText === "Tiempo" && (
                ...
                >
                  <Text
                    ...
                    pb="1rem"
                  >
                    Trece a quince semanas, con un mínimo de 480 horas y un
                    máximo de 525 horas.
                  </Text>
                </motion.div>
              )}
              ...
              {selectedText === "Registro" && (
                ...
                >
                  <Text
                    ...
                    pb="1rem"
                  >
                    En caso de traer una empresa por tu cuenta debe estar
                    validada por tu coordinador y llevar los siguientes datos al
                    área de practicas y estadías ubicada en el edificio C planta
                    baja. <br />
                    <span style={{ fontWeight: "bold" }}>1.- </span> Nombre de
                    la empresa <br />
                    <span style={{ fontWeight: "bold" }}>2.- </span> Dirección y
                    ciudad de la empresa <br />
                    <span style={{ fontWeight: "bold" }}>3.- </span> Nombre del
                    contacto
                    <br />
                    <span style={{ fontWeight: "bold" }}>4.- </span> Cargo del
                    contacto
                    <br />
                    <span style={{ fontWeight: "bold" }}>5.- </span> Teléfono y
                    e-mail del contacto
                    <br />
                  </Text>
                </motion.div>
              ...
              {selectedText === "Asesor" && (
                ...
                >
                  <Text
                    ...
                    color="rgba(0, 0, 0, 0.74)"
                  >
                    <span style={{ fontWeight: "bold" }}>Nombre: </span>Jorge
                    Rogelio García.
                    <br />
                    <span style={{ fontWeight: "bold" }}>Correo: </span>{" "}
                    jorge.garcia@utng.edu.mx
                    <br />
                    <span style={{ fontWeight: "bold" }}>
                      Número de télefono:{" "}
                    </span>
