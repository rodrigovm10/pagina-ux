...
import { MenuCircular } from './MenuCirular.jsx'
const vacaciones = [
	'2023-12-21',
	'2023-12-22',
	'2023-12-26',
...
>>>>>>> 4b3e73288c679364f2cb7bade1874c6fbfdb14c4
	...
	const getEventsForDay = selectedDay => {
		...
		const events = CARDS_CALENDAR.filter(event => {
			...
			const eventDate = new Date(selectedDay.getFullYear(), monthIndex, parseInt(dayPart))
          ...
          {viewMode === "calendar" && selectedDayEvents.length > 0 ? (
            ...
            >
              ...
              />
							...
							<Stack>
								<CardBody>
									<Heading size='md'>Bienvenidos al Calendario Académico</Heading>

									<Text py='2'>
										Nos complace presentarles el Calendario Académico. Este calendario es una herramienta esencial para
										planificar y organizar sus actividades académicas y eventos universitarios a lo largo del año. En
										él, encontrarán fechas importantes como el eventos deportivos, danza, etc. Les invitamos a
										consultarlo regularmente para estar al tanto de todas las actividades y plazos relevantes.
									</Text>
								</CardBody>
							</Stack>
						</Card>
