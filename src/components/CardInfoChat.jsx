              ...
              {selectedText === "Descripcion" && (
                ...
                >
                  <Text
                    ...
                    pb="1rem"
                  >
                    Utiliza el chat para resolver alguna de tus dudas que no
                    hayas encontrado. Nuestro equipo de asesores te brindará la
              ...
              {selectedText === "Como" && (
                ...
                >
                  ...
                  >
                    ...
                    <br />
                    <span style={{ fontWeight: "bold" }}>2.- </span>En la parte
                    de abajo a la derecha se abrira el chat.
                    <br />
                    <span style={{ fontWeight: "bold" }}>3.1.- </span>Selecciona
                    una opción de la cual tengas dudas.
                    <br />
                    ...
                    <br />
                    <span style={{ fontWeight: "bold" }}>4.- </span>Proporciona
                    un correo y serás respondido para llevar un seguimiento de
                    tu duda.
                  </Text>
                </motion.div>
              )}
