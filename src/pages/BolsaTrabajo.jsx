...
function BolsaTrabajo() {
	...
	const jobs = [
		...
		},
		{
			...
			image: '/src/assets/chambaaa.jpg',
			pago: '150-200/Hora',
			ubicacion: 'Calle de los Estudiantes 45, Colonia Educativa, 37500 Guanajuato, Gto.',
		...
		},
		{
			...
			ubicacion: 'Boulevard Independencia 234, Colonia Independencia, 37050 León, Gto.',
							...
							: jobs.map(job => (
									...
									>
										<Box
											...
											onClick={() => handleJobClick(job)}
											cursor='pointer'
											borderLeft={selectedJob && selectedJob.id === job.id ? '3px solid #00259A' : ''}
										>
											<Heading
												as='h3'
												size='md'
